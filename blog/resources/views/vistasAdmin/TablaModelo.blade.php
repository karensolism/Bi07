 ...
 <!-- begin panel -->
        <div class="panel panel-inverse" data-sortable-id="table-basic-7">
            ...
            <div class="panel-heading">
                ...
                <h4 class="panel-title">UI Elements in Table <span class="label label-success m-l-5 t-minus-1"><a href="Modelo/create">Agregar</a></li></span></h4>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="with-btn" nowrap>
                                    <a href="{{route('Modelo.edit',$modelo->Id_modelo)}}" class="btn btn-sm btn-primary width-60 m-r-2">Editar</a>
