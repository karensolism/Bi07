...
{{csrf_field()}}
                    ...
                    <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                      <!-- begin panel-heading -->
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Caracteristicas</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                   
     <h5 class="card-title">Catálogo Caracteristicas</h5>

              <!--En este lo puse no visible porque el usuario no debe ser capaz de interactuar con las llaves primarias-->
       <input type="hidden" id="txt_IdProducto" name="id_producto" value="" >
       <!--id no visible-->
       <br/>
     ...
     <select id="activoProducto" name="Activo">
         <option value="1">si</option>
         <option value="0">no</option>
       </select>
       <br/>
       <!--Modelo-->
       <label for="Producto" class="label-text">Producto</label>
       <br/>
       <input type="text" id="txt_producto" name="Producto" class="text">
       <br/> 
       <!--Mostrara los tipos de inmueble que existen -->
       <select id="id_seminuevo" name="id_seminuevofk">
         <option value="1">si</option>
         <option value="0">no</option>
       </select>
       <br/>
